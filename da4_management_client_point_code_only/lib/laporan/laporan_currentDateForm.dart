import 'dart:async';
import 'laporan_readyUpload.dart';
...
class LaporanTodayScreen extends StatefulWidget {
  ...
  LaporanTodayScreen({required this.currentdate, required this.edit});
