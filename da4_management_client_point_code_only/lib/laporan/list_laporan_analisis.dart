...
import 'package:da4_management_client_point/laporan/laporan_readyUpload.dart';
import 'package:flutter/material.dart';
import '../backend/laporanDataHandlerFirestore.dart';
//import 'laporan_readySetor.dart';
import '../backend/control.dart';

class ListLaporanAnalisisScreen extends StatefulWidget {
  final String chooseTokoID;
  final String chooseTokoName;
  final List<String> customList;

  ListLaporanAnalisisScreen(
      {required this.chooseTokoID,
      required this.chooseTokoName,
      required this.customList});

  @override
  _ListLaporanAnalisisScreenState createState() => _ListLaporanAnalisisScreenState();
}

class _ListLaporanAnalisisScreenState extends State<ListLaporanAnalisisScreen> {
  ...
  Future<bool> getUploadStatus(String selectedDate) async {
    try {
      Map<String, dynamic> jsonData = await LaporanDatabaseHandlerFirestore
          .instance
          .loadLaporanFromFirestore(selectedDate);
