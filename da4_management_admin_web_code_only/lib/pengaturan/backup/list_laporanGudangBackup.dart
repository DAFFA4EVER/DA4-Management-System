import 'package:da4_management/pengaturan/backup/barang_gudangBackup.dart';
import 'package:flutter/material.dart';
import '../../backend/gudangDataHandlerFirestore.dart';
import '../../backend/control.dart';

class ListLaporanGudangBackupScreen extends StatefulWidget {
  final String chooseTokoID;
  final String chooseTokoName;
  final List<String> customList;

  ListLaporanGudangBackupScreen(
      {required this.chooseTokoID,
      required this.chooseTokoName,
      required this.customList});

  @override
  _ListLaporanGudangBackupScreenState createState() =>
      _ListLaporanGudangBackupScreenState();
}

class _ListLaporanGudangBackupScreenState extends State<ListLaporanGudangBackupScreen> {
                              ...
                              child: ListTile(
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => GudangLaporanBackupScreen(
