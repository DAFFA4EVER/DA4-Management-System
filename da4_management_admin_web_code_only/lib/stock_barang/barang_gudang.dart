...
class _GudangLaporanScreenState extends State<GudangLaporanScreen> {
  ...
  void initState() {
    ...
    //DateTime currentDateParse = DateTime.parse(currentDate);
    //DateTime previousDateToParse = currentDateParse.subtract(Duration(days: 1));
    canEdit = widget.edit;
    checkLaporanExist();
  }
  ...
  void predictStokGudang() {
    try {
      ...
      if (udahUpload == false) {
        ...
        laporanGudangData['prediksi'] = barangPrediksiStockItems;
      }
      barangPrediksiStockItems = laporanGudangData['prediksi'];
    } catch (e) {
      print(e);
                            ...
                            child: Column(
                              children: [
                                ...
                                ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    final stock =
                                        barangPrediksiStockItems[index];
                                    final quantity = stock['quantity'] ?? 0;
                                    return Card(
                                      child: ListTile(
                                        title: Text(stock['nama']),
                      ...
                      child: Column(
                        children: [
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final itemBuktiMasuk = buktiBarangMasukItem[
                                      index] ??
                      ...
                      child: Column(
                        children: [
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final itemBuktiKeluar = buktiBarangKeluarItem[
                                      index] ??
                                  {}; // Initialize with an empty map if null
                              final TextEditingController namaController =
                                  TextEditingController(
