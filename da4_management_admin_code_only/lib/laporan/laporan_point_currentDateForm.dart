...
class LaporanTodayPointScreen extends StatefulWidget {
  ...
  @override
  _LaporanTodayPointScreenState createState() =>
      _LaporanTodayPointScreenState();
}
...
class _LaporanTodayPointScreenState extends State<LaporanTodayPointScreen> {
  ...
  Future<String> getPreviousStock() async {
    ...
    final gudangList = await LaporanDatabaseHandlerFirestore.instance
        .getLaporanList(widget.chooseTokoID);
    //print('xx');
    ...
    //print('xxx');
    if (availableDate.isNotEmpty && currentDate == availableDate.last) {
  ...
  Future<void> checkLaporanExist() async {
    try {
      ...
      if (await laporanHelper.checkLaporanExist(
          ...
          false) {
        laporanData =
            laporanHelper.laporanTemplate(currentDate, widget.chooseTokoID);
      } else {
      ...
      if ((await laporanHelper.checkLaporanExist(
                  previousDate, widget.chooseTokoID) ==
              true) &&
          (laporanData['uploaded'] == false)) {
        if (canEdit) {
          print('Today Not Exist');
          Map<String, dynamic> laporanTokoYesterdayData = await laporanHelper
              .loadLaporanFromFirestore(previousDate, widget.chooseTokoID);
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            "Struk Copy : ${copyStatus}",
                          ),
                          Text("Waktu : $timeOrder"),
                        ],
                      ),
                      SizedBox(
                        height: 8,
                                                                      ...
                                                                      IconButton(
                                                                          onPressed:
                                                                            ...
                                                                            showPesananList(
                                                                                ...
                                                                                pesanan, pemasukan['print'], orderTime);
                                                                          },
                                                                          icon:
