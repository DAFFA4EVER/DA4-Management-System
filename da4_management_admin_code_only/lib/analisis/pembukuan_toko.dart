import 'package:da4_management/analisis/detail%20laporan/detail_setor.dart';
import 'package:da4_management/analisis/detail%20laporan/detail_pengeluaran.dart';
import 'package:da4_management/export/pdf_laporanAbsen.dart';
import 'detail laporan/detail_strukCash.dart';
import 'package:da4_management/backend/laporanDataHandlerFirestore.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import '../laporan/list_laporan.dart';
import 'detail laporan/detail_menu.dart';
import 'detail laporan/detail_pemasukan.dart';
import '../export/pdf_laporanToko.dart';

class PembukuanTokoScreen extends StatefulWidget {
  ...
  @override
  _PembukuanTokoScreenState createState() => _PembukuanTokoScreenState();
}

class _PembukuanTokoScreenState extends State<PembukuanTokoScreen> {
  ...
  Future<void> pembukuanProcess() async {
    for (int i = 0; i < widget.listDate.length; i++) {
      ...
      final tempLaporanData = await LaporanDatabaseHandlerFirestore.instance
          .loadLaporanFromFirestore(widget.listDate[i], widget.chooseTokoID);
      setState(() {
        processProgress = i;
      });
      // add menu data
