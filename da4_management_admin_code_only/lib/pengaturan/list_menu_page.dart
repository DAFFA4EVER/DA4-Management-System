...
import 'menu/menu_edit.dart';
import 'package:intl/intl.dart';
import 'menu/menu_add.dart';
...
class _ListMenuScreenState extends State<ListMenuScreen> {
  ...
  int getIndex(Menu selectedMenu) {
    int indexMenu = menuList.toList().indexOf(selectedMenu);
    return indexMenu;
  }
