import 'package:da4_management/pengaturan/backup/laporan_backup.dart';
import 'package:flutter/material.dart';
import '../../backend/laporanDataHandlerFirestore.dart';
import '../../backend/control.dart';

class ListLaporanBackupScreen extends StatefulWidget {
  final String chooseTokoID;
  final String chooseTokoName;
  final List<String> customList;

  ListLaporanBackupScreen(
      {required this.chooseTokoID,
      required this.chooseTokoName,
      required this.customList});

  @override
  _ListLaporanBackupScreenState createState() =>
      _ListLaporanBackupScreenState();
}

class _ListLaporanBackupScreenState extends State<ListLaporanBackupScreen> {
